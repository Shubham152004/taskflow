...
export default function Navbar({ searchTask, setSearchTask }) {
    ...
    return (
        ...
        <li><button onClick={handleDarkModeToggle} className="bg-slate-700 text-white rounded-lg p-2 hover:bg-slate-600 transition-colors">🌙</button></li>
